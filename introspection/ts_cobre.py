...
# I am attaching what you need to reproduce a dataset for COBRE.
...
def load_COBRE_origin(
    dataset_path: str = DATA_ROOT.joinpath("cobre/COBRE_AllData.h5"),
    hc_path: str = DATA_ROOT.joinpath("cobre/COBRE_HC_TrainingIndex.h5"),
    sz_path: str = DATA_ROOT.joinpath("cobre/COBRE_SZ_TrainingIndex.h5"),
    indices_path: str = DATA_ROOT.joinpath("cobre/correct_indices_GSP.csv"),
    index_array_path: str = DATA_ROOT.joinpath("cobre/index_array_labelled_COBRE.csv"),
    labels_path: str = DATA_ROOT.joinpath("cobre/labels_COBRE.csv"),
):
    ID = 5
    ntrials = 1
    ...
    hf = h5py.File(dataset_path, "r")  # "../Data/COBRE_AllData.h5"
    data = hf.get("COBRE_dataset")
    data = np.array(data)
